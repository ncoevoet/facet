...
| `python facet.py --detect-panoramas` | Detectar panorámicas emparejando geométricamente las miniaturas almacenadas (biblioteca completa, CPU, sin decodificar imágenes). Se ejecuta al final de cada análisis |
