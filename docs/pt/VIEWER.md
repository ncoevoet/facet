...
| `PUT /api/albums/{id}/scoring_context` | `[Edition]` Define o contexto de pontuação do álbum; materializa-o nas fotos membro neste momento (álbuns inteligentes resolvem `smart_filter_json` ao vivo), retorna `{updated, conflicts}` |
