...
| `python facet.py --detect-panoramas` | Detetar panorâmicas comparando geometricamente as miniaturas armazenadas (biblioteca completa, CPU, sem descodificar imagens). Corre no fim de cada análise |
