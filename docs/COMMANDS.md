...
| `python facet.py --detect-panoramas` | Detect panorama sets by matching stored thumbnails geometrically (whole library, CPU, no image decode). Runs at the end of every scan |
