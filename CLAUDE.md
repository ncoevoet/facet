...
**Sequences (exposure brackets, `--detect-sequences`):** sequence_group_id, sequence_kind (`bracket`), sequence_ev_offset (exposure compensation vs the set's base frame, signed like a camera's AEB display: `-2` dark, `+2` bright)
